...
import { FetchCategoryDetail } from '../../Redux/BlogComponent/CatedetailSlice'
...
const Categorydetails = () => {
    const { category_detail } = useSelector((state) => state?.cetegoryDetail)
    const { id } = useParams()
                                    ...
                                    <div className="col-lg-8 entries">
                                        <article className="entry entry-single" data-aos="fade-up">
                                            <div className="entry-img">
                                                <img src={`https://restapinodejs.onrender.com/api/blog/image/${category_detail?._id}`} className="card-img-top" alt="..." />
                                            ...
                                            <div className="entry-meta">
                                                <ul>
                                                    ...
                                                    <li className="d-flex align-items-center"><i className="icofont-wall-clock" /> <a href="blog-single.html"><time dateTime="2023-06-28">{moment(category_detail?.createdAt).format(' Do MM  YYYY, h:mm:ss a')}</time></a></li>
                                    ...
                                    Alias quia non aliquid. Eos et ea velit. Voluptatem maxime enim omnis ipsa voluptas incidunt. Nulla sit eaque mollitia nisi asperiores est veniam.
                                        ...
                                        <div className="blog-comments" data-aos="fade-up">
                                            ...
                                            <div id="comment-1" className="comment clearfix">
                                                ...
                                                <time dateTime="2023-06-28">{moment(category_detail?.createdAt).format(' Do MM  YYYY, h:mm:ss a')}</time>
                                                <p>
